...
import {NativeBaseProvider, extendTheme, IconButton, Center} from "native-base";
...
import WordLevel from "./screens/WordLevel";
import WordsContextProvider from './stores/words-context'
                ...
                <NativeBaseProvider theme={theme}>
                    <NavigationContainer>
                        <Stack.Navigator screenOptions={
                            ...
                            <Stack.Screen name="FlashCards" component={FlashCards} options={({navigation}) => ({
                                presentation: 'modal',
                                title: "Уншлага",
                                headerRight: () => (
                                    <IconButton borderRadius="full" onPress={() => {
                            ...
                            <Stack.Screen name="WordLevel" component={WordLevel} options={{
                                presentation: 'modal',
                                title: "Түвшин сонгох"
                            }}/>
